...
<head>
    ...
    <title> Myride | Admin Login</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="assets/images/myride-admin-full-high.png" alt="logo" width="300"/></span>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" method="POST" action="php/admin_login.php">
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-info" id="to-recover" type="button"><i class="fa fa-lock-open m-r-5"></i> Lost password?</button>
                                        <button class="btn btn-success float-right" name="login" value="clicked" type="submit">Login</button>
                                    </div>
                                </div>
                            </div>
                        </div>
