...
//                var_dump($car_type_private);
                ...
                $car_fare=mysqli_query($conn,"select distinct farepkm from car");
            ?>
            <?php
            if(mysqli_num_rows($car_type_private)>0 or mysqli_num_rows($car_type_commercial)>0){
                ?>
                <div style="text-align: center;">
                    <form style="font-size: 15pt; align-items: center" method="post" action="php/search_car.php">
...
<!--                                Car Fare-->
                                <td>
                                    <label for="cars">Choose car fare per km: </label>
                                    <select id="fare" name="fare" style="width: 30%">
                                        <option value="" selected>All fare</option>
                                        <?php while($row=mysqli_fetch_array($car_fare)){
                                            ?><option value="<?php echo $row[0] ?>"> <?php echo $row[0] ?></option><?php
                                        }
                                        ?>
                                    </select>
